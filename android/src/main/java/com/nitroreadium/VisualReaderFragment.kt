...
import com.nitroreadium.databinding.FragmentReaderBinding
...
abstract class VisualReaderFragment : BaseReaderFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //            // This will automatically turn pages when tapping the screen edges or arrow
        // keys.
        ...
        //                    Log.i("ReaderFragment", "${event.point}")
        //                    return super.onTap(event)
        //                }
        //
        //                override fun onDrag(event: DragEvent): Boolean {
        //                    Log.i("ReaderFragment", "${event.type}, ${event.offset},
        // ${event.start}")
        ...
        //            if (disableTouches) {
        //                // Add an invisible box on top of the navigator to intercept touch
        // gestures.
        //                Box(
        //                    modifier = Modifier
        //                        .fillMaxSize()
    ...
    //                }
    //
    //            // Prevent interacting with the publication (including page turns) while the TTS
    // is
    //            // playing.
    //            isPlaying
    ...
    //        override fun onDecorationActivated(event: DecorableNavigator.OnActivatedEvent):
    // Boolean {
    ...
    //                    Log.d("VisualReaderFragment", "Text selection detected: $selection")
    //                }
    //            }
    //
    ...
    //    }
    //
    //    private fun showHighlightPopup(rect: RectF, style: Highlight.Style, highlightId: Long? =
    // null) {
    //        viewLifecycleOwner.lifecycleScope.launch {
    ...
    //                if (isReverse) R.layout.view_action_mode_reverse else
    ...
    //            val inflater =
    //                requireActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE) as
    // LayoutInflater
    //
 ...
 */
@Parcelize data class DecorationStyleAnnotationMark(@ColorInt val tint: Int) : Decoration.Style
 ...
 */
@Parcelize data class DecorationStylePageNumber(val label: String) : Decoration.Style
