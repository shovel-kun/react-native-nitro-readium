...
public final class NitroReadiumAutolinking {
  ...
  /**
   * Creates an instance of a Swift class that implements `HybridPublicationSpec`,
   * and wraps it in a Swift class that can directly interop with C++ (`HybridPublicationSpec_cxx`)
   *
   * This is generated by Nitrogen and will initialize the class specified
   * in the `"autolinking"` property of `nitro.json` (in this case, `HybridPublication`).
   */
  public static func createPublication() -> bridge.std__shared_ptr_margelo__nitro__nitroreadium__HybridPublicationSpec_ {
    let hybridObject = HybridPublication()
    return { () -> bridge.std__shared_ptr_margelo__nitro__nitroreadium__HybridPublicationSpec_ in
      let __cxxWrapped = hybridObject.getCxxWrapper()
      return __cxxWrapped.getCxxPart()
    }()
  }
